...
namespace WebApp.Migrations
{
    ...
    [Migration("20231201105956_AddUserToLot")]
    partial class AddUserToLot
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.CarModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("50f401a0-aa89-4680-bff1-0722b40a4462"),
            ...
            modelBuilder.Entity("Entities.Models.Lot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("13353d47-4ce9-42ea-892f-8e397b6ef6d0"),
                            CarBrandId = new Guid("80abbca8-664d-4b20-b5de-024705497d4a"),
                            CarModelId = new Guid("c9d4c053-49b6-410c-bc78-2d54a9991870"),
                            Description = "Color = REd",
                            Millage = 300000,
                            PostDate = new DateTime(2023, 12, 1, 13, 59, 55, 834, DateTimeKind.Local).AddTicks(9431),
                            Price = 1000000m,
                            ReleaseYear = 1999,
                        ...
                        new
                        {
                            Id = new Guid("43e89a5f-24f8-495c-abfc-9b7468d4e5d3"),
                            CarBrandId = new Guid("80abbca8-664d-4b20-b5de-024705497d4a"),
                            CarModelId = new Guid("3d490a70-94ce-4d15-9494-5248280c2ce3"),
                            Description = "Description",
                            Millage = 199213,
                            PostDate = new DateTime(2023, 12, 1, 13, 59, 55, 834, DateTimeKind.Local).AddTicks(9598),
                            Price = 1000000m,
                            ReleaseYear = 2005,
                            User = new Guid("00000000-0000-0000-0000-000000000000")
                        });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "f5f399c7-52ea-4759-a03d-82e4a0dc3a38",
                            ConcurrencyStamp = "cf713572-f9a4-4f0e-80d9-633efca64069",
                            Name = "User",
                            NormalizedName = "User"
                        },
                        new
                        {
                            Id = "4bc9677e-b3e3-4062-853a-43aa07260913",
                            ConcurrencyStamp = "ae108995-351a-4b9f-8329-5e54f1d90d76",
                            Name = "Admin",
